...
)
{
    ...
    if (pCtxConfig->eSnsMode == AX_SNS_LINEAR_MODE) {
        ...
        tShutterTbl.nIntTime[AXAE_LONG_FRAME] = lineNum;
        ...
        tShutterTbl.nIntTime[AXAE_LONG_FRAME] = lineNum;
        tShutterTbl.fHdrRatio[AXAE_LONG_FRAME] = pAlgCtx->tConfig.hdrRatio;
        tShutterTbl.nIntTime[AXAE_MEDIUM_FRAME] = lineNum;
        ...
        tShutterTbl.nIntTime[AXAE_MEDIUM_FRAME] = lineNum;
        tShutterTbl.fHdrRatio[AXAE_MEDIUM_FRAME] = pAlgCtx->tConfig.hdrRatio;
        tShutterTbl.nIntTime[AXAE_SHORT_FRAME] = lineNum;
...
)
{
    ...
    snsShutter = tSnsParam.sns_ae_param.nCurIntegrationTime[AXAE_LONG_FRAME] * tSnsParam.fTimePerLine;
    ...
    pAlgCtx->tStatus.hdrHwMaxShutter = tSnsParam.sns_ae_limit.tIntTimeRange.nMaxIntegrationTime[AX_SNS_HDR_FRAME_L] * tSnsParam.fTimePerLine;
    ...
    if (hdrMode == AX_SNS_LINEAR_MODE) {
        ...
        shortShutter  = tSnsParam.sns_ae_param.nCurIntegrationTime[AXAE_MEDIUM_FRAME] * tSnsParam.fTimePerLine;
        ...
        vsShutter  = tSnsParam.sns_ae_param.nCurIntegrationTime[AXAE_SHORT_FRAME] * tSnsParam.fTimePerLine;
...
(
    ...
    //Init Hardware limit.
    pCtxConfig->IntegrationTimeLimit.fMax =  tSnsParam.sns_ae_limit.tIntTimeRange.nMaxIntegrationTime[AXAE_LONG_FRAME] * tSnsParam.fTimePerLine;
    pCtxConfig->IntegrationTimeLimit.fMin =  tSnsParam.sns_ae_limit.tIntTimeRange.nMinIntegrationTime[AXAE_LONG_FRAME] * tSnsParam.fTimePerLine;
    pCtxConfig->IntegrationTimeLimit.fStep = tSnsParam.sns_ae_param.nIntegrationTimeIncrement[AXAE_LONG_FRAME];
    ...
    pCtxConfig->sIntegrationTime.fMax =  tSnsParam.sns_ae_limit.tIntTimeRange.nMaxIntegrationTime[AXAE_MEDIUM_FRAME]  * tSnsParam.fTimePerLine;
    pCtxConfig->sIntegrationTime.fMin =  tSnsParam.sns_ae_limit.tIntTimeRange.nMinIntegrationTime[AXAE_MEDIUM_FRAME]  * tSnsParam.fTimePerLine;
    pCtxConfig->sIntegrationTime.fStep = tSnsParam.sns_ae_param.nIntegrationTimeIncrement[AXAE_MEDIUM_FRAME];
    ...
    pCtxConfig->sVsintegrationTime.fMax =  tSnsParam.sns_ae_limit.tIntTimeRange.nMaxIntegrationTime[AXAE_SHORT_FRAME]  * tSnsParam.fTimePerLine;
    pCtxConfig->sVsintegrationTime.fMin =  tSnsParam.sns_ae_limit.tIntTimeRange.nMinIntegrationTime[AXAE_SHORT_FRAME]  * tSnsParam.fTimePerLine;
    pCtxConfig->sVsintegrationTime.fStep = tSnsParam.sns_ae_param.nIntegrationTimeIncrement[AXAE_SHORT_FRAME];
...
)
{
    ...
    for(int i = 0 ;i<tSnsParam.sns_dev_attr.eSnsMode;i++){
        ...
        tSnsParam.sns_ae_limit.tIntTimeRange.nMinIntegrationTime[i] = 1;
        tSnsParam.sns_ae_limit.tIntTimeRange.nMaxIntegrationTime[i] = 33000;
