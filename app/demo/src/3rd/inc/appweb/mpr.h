...
#define lock_appweb(arg)       if (arg && (arg)->mutex) mprLock((arg)->mutex)
#define unlock_appweb(arg)     if (arg && (arg)->mutex) mprUnlock((arg)->mutex)
#define spinlock_appweb(arg)   if (arg) mprSpinLock((arg)->spin)
#define spinunlock_appweb(arg) if (arg) mprSpinUnlock((arg)->spin)
