...
public:
  ...
  struct timeval getPresentationTime() const {return fPresentationTime;};
  struct timeval getPresentationTimeSpecified() const {return fPresentationTimeSpecified;};
...
protected:
  ...
  struct timeval fPresentationTimeSpecified; // in
