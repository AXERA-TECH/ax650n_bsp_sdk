...
// A filter that reads PCM Generic audio frames, and outputs each frame with
// C++ header

#ifndef _PCM_GENERIC_STREAM_FRAMER_HH
#define _PCM_GENERIC_STREAM_FRAMER_HH

#ifndef _FRAMED_FILTER_HH
#include "FramedFilter.hh"
#endif

class PCMGenericStreamFramer: public FramedFilter {
public:
  static PCMGenericStreamFramer*
...
protected:
  ...
  virtual ~PCMGenericStreamFramer();
