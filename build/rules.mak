...
ifneq ($(ROOTFS_TARGET_PATH)/etc, $(wildcard $(ROOTFS_TARGET_PATH)/etc))
	...
	@-$(CP) -r -P -p $(INSTALL_ETC) $(ROOTFS_TARGET_PATH)/etc/
...
ifneq ($(SONAME),)
	...
	@bash $(SCRIPTS_PATH)/axera_module_version.sh $(GENERATED_PATH)/ax_module_version.h $(SONAME) $(SDK_VERSION)
endif
endif
