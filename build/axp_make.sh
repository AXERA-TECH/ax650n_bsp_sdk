...
if [ "$PROJECT" = "AX650_emmc" ] || [ "$PROJECT" = "AX650_pipro_box" ] || [ "$PROJECT" = "AX650_master" ] || [ "$PROJECT" = "AX650_xpilot_6v" ]; then
...
if [ "$PROJECT" = "AX650_emmc" ] || [ "$PROJECT" = "AX650_pipro_box" ] || [ "$PROJECT" = "AX650_ssd" ] || [ "$PROJECT" = "AX650_master" ] || [ "$PROJECT" = "AX650_xpilot_6v" ]; then
	...
	BIN_LIST="$EIP_PATH $FDL2_PATH $UBOOT_PATH $DTB_PATH $BOOT_PATH $ATF_PATH $ROOTFS_PATH"
elif [ "$PROJECT" = "AX650_slave" ]; then
